...
Если скормить Monic файл f3.js, то на выходе получим:
...
Директива `#without` указывает Monic исключить из сборки все файлы,
...
В случае с Monic файл String.js размечается на области.
